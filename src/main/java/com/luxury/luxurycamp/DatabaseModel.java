...
public class DatabaseModel {
    ...
    public DatabaseModel() {
        ...
        accommodationDetails.add(new AccommodationDetails(1, "Geodesic Dome", "Unoccupied", "Available", new AccommodationArea("Woodland", "A woodland area echoing the sounds of nature and wildlife.", 0, 2), new CleaningStatus("Requires Cleaning"), new AccommodationsReception("Nadine", "Smith", 12334345, 0, "05-10-22", 2, false), new AccommodationInfo("Geodesic Dome", 3, 2, 120.0, "Hello")));
