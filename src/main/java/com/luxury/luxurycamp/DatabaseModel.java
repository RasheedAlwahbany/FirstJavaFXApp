...
public class DatabaseModel {
    ...
    public DatabaseModel() {
        ...
        accommodationDetails.add(new AccommodationDetails(1, "Luxury Tent", "Occupied", "Available", new AccommodationArea("Woodland", "Area 1 Description", 0, 1), new CleaningStatus("Clean"), new AccommodationsReception("Nadine", "Smith", 12334345, 0, "05-10-22", 2, true), new AccommodationInfo("Geodesic Dome", 3, 2, 120.0, "Hello")));
        accommodationDetails.add(new AccommodationDetails(2, "Luxury Tent", "Occupied", "Available", new AccommodationArea("Woodland", "Area 1 Description", 2, 1), new CleaningStatus("Clean"), new AccommodationsReception("Nadine", "Smith", 12334345, 2, "05-10-22", 2, true), new AccommodationInfo("Geodesic Dome", 3, 2, 120.0, "Hello")));
        accommodationDetails.add(new AccommodationDetails(3, "Luxury Tent", "Occupied", "Available", new AccommodationArea("Woodland", "Area 1 Description", 0, 1), new CleaningStatus("Clean"), new AccommodationsReception("Nadine", "Smith", 12334345, 0, "05-10-22", 2, true), new AccommodationInfo("Geodesic Dome", 3, 2, 120.0, "Hello")));
        accommodationDetails.add(new AccommodationDetails(4, "Luxury Tent", "Occupied", "Available", new AccommodationArea("Woodland", "Area 1 Description", 2, 1), new CleaningStatus("Clean"), new AccommodationsReception("Nadine", "Smith", 12334345, 2, "05-10-22", 2, true), new AccommodationInfo("Geodesic Dome", 3, 2, 120.0, "Hello")));
